                ...
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <label class="ckbox">
                      ...
                      <span></span>
                                ...
                                <td class="align-middle"><?= substr(strip_tags($value->description), 0, 70);
                                                            if (strlen(strip_tags($value->description)) > 70) echo '...' ?></td>
                                <td class="text-right">
                                    ...
                                    <a href="<?= base_url(); ?>panel/settings/delete/<?= $this->uri->segment(2); ?>/<?= $value->id; ?>" class="btn btn-sm btn-secondary" onclick="return confirm('Czy na pewno chcesz usunąć <?= strip_tags($value->description) ?>? #<?= $value->id; ?>')">
