                ...
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <label class="ckbox">
                      ...
                      <span></span>
                                ...
                                <td class="align-middle"><?= substr($value->name, 0, 70);
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="<?= base_url(); ?>panel/settings/delete/<?= $this->uri->segment(2); ?>/<?= $value->id; ?>" class="btn btn-sm btn-secondary" onclick="return confirm('Czy na pewno chcesz usunąć <?= $value->name; ?>? #<?= $value->id; ?>')">
