...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody mg-t-0 pd-x-30">
        ...
        <form class="form-layout form-layout-6" action="<?php echo base_url() . 'panel/' . $this->uri->segment(2) . '/action/' . $this->uri->segment(4) . '/' . $this->uri->segment(2); ?>/<?php echo @$value->id; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2">
                    Napis przycisku listingu:
                </div>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" name="listing_button_name" value="<?= @$value->listing_button_name; ?>">
                </div>
            </div>
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2">
            ...
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2">
                    Napis przycisku udziału w konkursie:
                </div>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" name="take_part_button_name" value="<?= @$value->take_part_button_name; ?>">
                </div>
            </div>
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2">
                    Napis przycisku regulaminu:
                </div>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" name="regulations_button_name" value="<?= @$value->regulations_button_name; ?>">
                </div>
            </div>
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2">
                    Napis przycisku "aplikuj":
                </div>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" name="application_button_name" value="<?= @$value->application_button_name; ?>">
                </div>
            </div>
            ...
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2 flex-wrap">
                    Regulamin:
                    <?php if (@$value->file_1) : ?>
                        <br>
                        <a class="d-block" download href="<?= uploads(@$value->file_1) ?>"><?= @$value->file_1 ?></a>
                    <?php endif ?>
                </div>
                <div class="col-12 col-sm-8 col-lg-9">
                    <label id="infoFile" class="form-control-label d-block"></label>
