            ...
            <div class="table-wrapper">
              ...
              foreach ($subpages as $value) : $i++; ?>
                        <tr>
                            ...
                            <td class="align-middle"><?php echo substr($value->page, 0, 70);
                                            if (strlen($value->page) > 70) echo '...' ?></td>
                            <td class="align-middle"><a href="<?= base_url() . $value->page ?>" target="_blank"
                                    title="Zobacz"><?php echo substr($value->title, 0, 70);
                                                                                                                      if (strlen($value->title) > 70) echo '...' ?></a>
                            </td>
                            <td class="text-right">
