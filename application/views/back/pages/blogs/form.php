...
<div class="br-mainpanel">
    ...
    <div class="br-pagebody mg-t-0 pd-x-30">
        ...
        <form class="form-layout form-layout-6" action="<?php echo base_url() . 'panel/' . $this->uri->segment(2) . '/action/' . $this->uri->segment(4) . '/' . $this->uri->segment(2); ?>/<?php echo @$value->id; ?>" method="post" enctype="multipart/form-data">
            ...
            <?php $photos = ["Listing", "Tło", "Baner pod opisem"] ?>
            ...
            <div class="row no-gutters">
                ...
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" name="created" value="<?= @$value->created; ?>" required>
                </div>
            </div>
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2">
            ...
            <div class="row no-gutters">
                ...
                <div class="col-12 col-sm-8 col-lg-9">
                    <textarea class="summernote" name="listing_description"><?php echo @$value->listing_description; ?></textarea>
            ...
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2">
                    Napis na banerze pod opisem:
                </div>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" name="banner_title" value="<?= @$value->banner_title; ?>">
                </div>
            </div>
            <div class="row no-gutters">
                <div class="col-12 col-sm-4 col-lg-2">
                    Napis przycisku na banerze pod opisem:
                </div>
                <div class="col-12 col-sm-8 col-lg-9">
                    <input class="form-control" type="text" name="banner_button_name" value="<?= @$value->banner_button_name; ?>">
                </div>
            </div>
